...
public class RVAdapter_OrdersList extends RecyclerView.Adapter<RVAdapter_OrdersList.OrderViewHolder>{
    private List<OrderModel> orders;
    private final RecyclerViewOnClickListener onClickListener;

    public RVAdapter_OrdersList(List<OrderModel> orders, RecyclerViewOnClickListener onClickListener) {
        this.orders = orders;
    ...
    public class OrderViewHolder extends RecyclerView.ViewHolder{
        private final RvItemPreviousOrdersCardBinding binding;
