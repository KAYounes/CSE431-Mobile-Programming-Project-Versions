...
public class CartItemsRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CartItemsRecyclerViewAdapter(List<CartItemModel> cartItems, RecyclerViewOnClickListener onClickListener) {
    ...
    public void setFooter(List<String> footerFields){
...
//    }
    ...
    private void bindFooter(FooterViewHolder holder, int position){
        ...
        binder.cartSubtotal.setText(footerFields.get(0));
        binder.deliverFee.setText(footerFields.get(1));
        binder.total.setText(footerFields.get(2));
    }
